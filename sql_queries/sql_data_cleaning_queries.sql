...
--1. Standardizing missing values in 'diag_1' column
UPDATE hospital_readmissions
SET diag_1 = NULL
WHERE diag_1 ILIKE 'unknown' OR diag_1 ILIKE 'missing';

--2. Standardizing missing values in 'diag_2' column
UPDATE hospital_readmissions
SET diag_2 = NULL
WHERE diag_2 ILIKE 'unknown' OR diag_2 ILIKE 'missing';

--3. Standardizing missing values in 'diag_3' column
UPDATE hospital_readmissions
SET diag_3 = NULL
WHERE diag_3 ILIKE 'unknown' OR diag_3 ILIKE 'missing';

--4. Standardizing missing values in 'medical_specialty' column
UPDATE hospital_readmissions
SET medical_specialty = NULL
WHERE medical_specialty ILIKE 'missing';

--Handling Categorical Columns with Missing Values
--1. Calculating the mode for 'glucose_test' column
...
--2. Imputing the missing values in 'glucose_test' column with mode
UPDATE hospital_readmissions
SET glucose_test = 'no'
WHERE glucose_test IS NULL;

--3. Calculating the mode for 'a1ctest' column
...
--4. Imputing the missing values in 'a1ctest' column with mode
UPDATE hospital_readmissions
SET a1ctest = 'no'
WHERE a1ctest IS NULL;

--5. Calculating the mode for 'change' column
...
--6. Imputing the missing values in 'change' column with mode
UPDATE hospital_readmissions
SET change = 'no'
WHERE change IS NULL;

--Handling Numeric Columns with Missing Values
--1. Imputing the missing values in 'time_in_hospital' column with median
UPDATE hospital_readmissions
...
--2. Imputing the missing values in 'n_medications' column with median
UPDATE hospital_readmissions
...
--3. Imputing the missing values in 'n_lab_procedures' column with median
UPDATE hospital_readmissions
